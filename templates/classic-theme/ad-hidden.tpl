...
<div id="titlebar" class="margin-bottom-0">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>{LANG_HIDDEN_JOBS}</h2>
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs">
                    <ul>
                        <li><a href="{LINK_INDEX}">{LANG_HOME}</a></li>
                        <li>{LANG_HIDDEN_JOBS}</li>
                    </ul>
                </nav>
        ...
        <div class="row">
                        ...
                        <div class="dashboard-nav-container">
                            ...
                            <div class="dashboard-nav-inner">
                              ...
                              <ul data-submenu-title="{LANG_MY_JOBS}">
                                ...
                                <li class="active"><a href="{LINK_HIDDENJOBS}"><i class="icon-feather-eye-off"></i> {LANG_HIDDEN_JOBS} <span class="nav-tag">{HIDDENADS}</span></a></li>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="dashboard-box margin-top-0">
                    <!-- Headline -->
                    <div class="headline">
                        <h3><i class="icon-feather-eye-off"></i> {LANG_HIDDEN_JOBS}</h3>
                    </div>
                    <div class="content with-padding">
                        <div class="table-responsive">
                            <table id="js-table-list" class="basic-table dashboard-box-list">
                                ...
                                {ELSE}
                                <tr>
                                    <td colspan="3" class="text-center">{LANG_NO_HIDDEN_JOB}</td>
                                </tr>
                                {:IF}
                            </table>
                        </div>
