                            ...
                            <div class="dashboard-nav">
                                <div class="dashboard-nav-inner">
                                    ...
                                    <ul data-submenu-title="{LANG_MY_JOBS}">
                                        ...
                                        {:IF}
                                        <li class="active"><a href="{LINK_APPLIED_JOBS}"><i class="icon-feather-briefcase"></i> {LANG_APPLIED_JOBS}
                                                <span class="nav-tag">{APPLIEDJOBS}</span></a></li>
                                        <li><a href="{LINK_FAVJOBS}"><i class="icon-feather-heart"></i> {LANG_FAV_JOBS} <span class="nav-tag fav-ad-count">{FAVORITEADS}</span></a></li>
