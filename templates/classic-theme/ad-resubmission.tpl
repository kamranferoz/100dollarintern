...
<div id="titlebar" class="margin-bottom-0">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>{LANG_RESUBMITTED_JOBS}</h2>
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs">
                    <ul>
                        <li><a href="{LINK_INDEX}">{LANG_HOME}</a></li>
                        <li>{LANG_RESUBMITTED_JOBS}</li>
                    </ul>
                </nav>
        ...
        <div class="row">
                        ...
                        <div class="dashboard-nav-container">
                            ...
                            <div class="dashboard-nav-inner">
                              ...
                              <ul data-submenu-title="{LANG_MY_JOBS}">
                                ...
                                <li class="active"><a href="{LINK_RESUBMITJOBS}"><i class="icon-feather-rotate-cw"></i> {LANG_RESUBMITTED_JOBS} <span class="nav-tag">{RESUBMITADS}</span></a></li>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="dashboard-box margin-top-0">
                    <!-- Headline -->
                    <div class="headline">
                        <h3><i class="icon-feather-rotate-cw"></i> {LANG_RESUBMITTED_JOBS}</h3>
                    </div>
                    <div class="content with-padding">
                        <div class="table-responsive">
                            <table id="js-table-list" class="basic-table dashboard-box-list">
                                ...
                                IF({TOTALITEM}){
                                {LOOP: ITEM}
                                <tr class="ajax-item-listing" data-item-id="{ITEM.product_id}">
                                    <td>
                                    ...
                                    <td>
                                       <span class="badge blue">{LANG_RESUBMITTED}</span>
                                    </td>
                                    <td>
