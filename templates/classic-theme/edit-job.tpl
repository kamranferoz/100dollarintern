                        ...
                        <div class="content with-padding padding-bottom-10">
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    "{SUBCATEGORY}"==""){ style='display: none' {:IF}>
                      ...
                      {/LOOP: POSTTYPES}
                          ...
                          {/LOOP: SALARYTYPES}
                                ...
                                {:IF}
                                    ...
                                    <div class="submit-field">
                                        ...
                                        <select class="selectpicker with-border"
                                                name="custom[{CUSTOMFIELDS.id}]" {CUSTOMFIELDS.required}>
                                ...
                                <div class="submit-field">
                                    ...
                                    <div class="input-with-icon">
                                        <input class="with-border" type="text" placeholder="{LANG_TYPE_ADDRESS}"
                                               name="location" id="address-autocomplete" value="{LOCATION}">
