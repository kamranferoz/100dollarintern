(function ($) {
    ...
    $(".read-more-text").on('click', function () {
        if ($('.read-more-toggle').hasClass('is-expanded')) {
            $(this).html($('.read-more-toggle').data('read-more'));
            $('.read-more-toggle').removeClass('is-expanded');
        } else {
            $(this).html($('.read-more-toggle').data('read-less'));
            $('.read-more-toggle').addClass('is-expanded');
        }
    });
})(this.jQuery);
