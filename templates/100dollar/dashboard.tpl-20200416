                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-md-12">
                                    <div class="submit-field">
                                        <h5>&nbsp;</h5>
                                        <div class="input-with-icon">
                                            <input class="with-border margin-bottom-0" type="text" placeholder="{LANG_MAX}"
...
<!--
                                    <div class="submit-field">
                                        ...
                                        <select id="skill1" name="skill1">
                                            ...
                                            <option value="WhatsApp Busines App">WhatsApp Busines App</option>
                                            <option value="Facabook Managment">Facabook Managment</option>
                                    ...
                                    <div class="submit-field">
                                        <h5>{LANG_SKILL2}</h5>
                                        <textarea class="with-border" id="pageContent" name="skill2" >{ABOUTME}</textarea>
                                    </div>
                                    <div class="submit-field">
                                        <h5>{LANG_SKILL3}</h5>
                                        <textarea class="with-border" id="pageContent" name="skill3" >{ABOUTME}</textarea>
                                    </div>
-->
                                    <div class="submit-field">
                                        <h5>{LANG_WEBSITE}</h5>
