                    ...
                    {LOOP: ITEM}
                        <div class="job-listing">
                            <div class="job-listing-details">
                                ...
                                IF('{ITEM.resume}' != ''){
                                <a href="{ITEM.resume}" class="job-type" download=""><i
                            ...
                            <div class="job-listing-footer with-icon">
                                <ul>
                                    ...
                                    <li data-tippy-placement="top" title="{LANG_SALARY_PER_MONTH}"><i
                                                class="la la-credit-card"></i> {ITEM.salary_min}
                                        IF('{ITEM.salary_max}' != ''){
                                        - {ITEM.salary_max}
                                        {:IF}</li>
                                    {:IF}
