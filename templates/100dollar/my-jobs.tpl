        ...
        <div class="row">
                            ...
                            <div class="dashboard-nav-inner">
                              ...
                              <ul data-submenu-title="{LANG_MY_JOBS}">
                                ...
                                <li><a href="{LINK_MYCOMPANIES}"><i class="icon-feather-box"></i> {LANG_MY_COMPANIES} <span class="nav-tag">{COMPANIES}</span></a></li>
                                  {:IF}
                                <li class="active"><a href="{LINK_MYJOBS}"><i class="icon-feather-briefcase"></i> {LANG_MY_JOBS} <span class="nav-tag">{MYADS}</span></a></li>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="dashboard-box margin-top-0">
                    <!-- Headline -->
                    <div class="headline">
                        <h3><i class="icon-feather-briefcase"></i> {LANG_MY_JOBS}</h3>
                    </div>
                    <div class="content with-padding">
                        <div class="row">
                            <div class="col-xl-4">
                                ...
                                <div class="input-with-icon">
                                    <input class="with-border" name="keywords" value="{KEYWORDS}" type="text" placeholder="{LANG_SEARCH}...">
                        ...
                        <div class="table-responsive">
                            <table id="js-table-list" class="basic-table dashboard-box-list">
                                ...
                                IF({ADSFOUND}){
                                {LOOP: ITEM}
                                <tr class="ajax-item-listing IF('{ITEM.hide}'=='1'){ opapcityLight {:IF}" data-item-id="{ITEM.id}">
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        IF("{ITEM.status}"=="rejected"){ <span class="badge red">{ITEM.status}</span> {:IF}
                                        IF("{ITEM.status}"=="expire"){ <span class="badge yellow">{ITEM.status}</span> {:IF}
                                        IF("{ITEM.hide}"=="1"){ <span class="badge red label-hidden">{LANG_HIDDEN}</span>{:IF}
                                    </td>
                                    <td>
                                        ...
                                        <a href="{LINK_EDIT-JOB}/{ITEM.id}" class="button gray ripple-effect ico" data-tippy-placement="top" title="{LANG_EDIT}"><i class="icon-feather-edit"></i></a>
                                        IF("{ITEM.hide}"=="0"){
                                        <a href="#" data-ajax-action="hideItem" class="button gray ripple-effect ico item-js-hide" data-tippy-placement="top" title="{LANG_HIDE}"><i class="icon-feather-eye-off"></i></a>
                                        {ELSE}
                                        <a href="#" data-ajax-action="hideItem" class="button gray ripple-effect ico item-js-hide" data-tippy-placement="top" title="{LANG_SHOW}"><i class="icon-feather-eye"></i></a>
                                        {:IF}
                                ...
                                {ELSE}
                                <tr>
                                    <td colspan="3" class="text-center">{LANG_NO_ACTIVE_JOB}</td>
                                </tr>
                                {:IF}
                            </table>
                        </div>
