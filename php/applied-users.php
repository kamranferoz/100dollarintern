...
if(checkloggedin()) {
    ...
    if (!empty($product)) {
        ...
        // Output to template
        $page = new HtmlTemplate ('templates/' . $config['tpl_name'] . '/applied-users.tpl');
        $page->SetParameter('OVERALL_HEADER', create_header($lang['APPLIED_USERS']));
        ...
        $page->SetParameter('PRODUCT_NAME', $product['product_name']);
