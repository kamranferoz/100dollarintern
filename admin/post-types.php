...
<main class="app-layout-content">
                                        ...
                                        <div class="panel panel-default quickad-main">
                                            <div class="panel-body">
                                                <h4 class="quickad-block-head">
                                                    <span class="quickad-category-title">All Job Types</span>
                                                                ...
                                                                <div class="panel-body">
                                                                    <form method="post" id="<?php echo $row['id']; ?>">
                                                                        ...
                                                                        <div class="panel-footer">
                                                                            <button type="button" class="btn btn-lg btn-warning quickad-type-edit" data-type-id="<?php echo $row['id']; ?>">
                                                                                <span class="ladda-label"><i class="fa fa-language"></i> Edit Language</span>
                                                                            </button>
                                                                            <button type="button" class="btn btn-lg btn-success ladda-button ajax-type-edit" data-style="zoom-in" data-spinner-size="40" onclick="editPostType(<?php echo $row['id']; ?>);">
    ...
    <script>
        function editPostType(id){
            ...
            $.post(ajaxurl+'?action=editPostType&'+data, function (response) {
                if (response != 0) {
    ...
    <script src="js/custom-manage/post-types.js"></script>
