        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a class="btn btn-sm btn-success" data-url="panel/testimonial_add.php" data-toggle="slidePanel" href="#">Add New</a>
                </div>
            </div>
            <div class="card-block">
                <div id="js-table-list">
                    <table class="js-table-checkable table table-vcenter table-hover" id="ajax_datatable" data-jsonfile="testimonials.php">
                        <thead>
                        <tr>
...
<div class="site-action">
    ...
    <div class="site-action-buttons">
        <button type="button" data-ajax-response="deletemarked" data-ajax-action="deleteTestimonial"
