...
if(isset($config['installed']))
{
    if($config['version'] == $installing_version){
        exit('Quickjob is already installed.');
    ...
    if(!isset($_POST['lang']))
        $step = 1;
           ...
           if (!isset($_POST['PCode']))
                ...
                $url = "https://bylancer.com/api/api.php?verify-purchase=" . $_POST['PCode'] . "&version=" . $installing_version . "&site_url=" . $site_url . "&email=" . $buyer_email;
                // Open cURL channel
                $ch = curl_init();
...
<head>
    ...
    <title>Quickjob Installation</title>
    ...
    <table width="500"  border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td><table width="500%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><span class="style1">Quickjob Installation : Error</span></td>
...
elseif($step == 1)
{
    ...
    <div class="container">
        <table border="0" align="center" cellpadding="10" cellspacing="3" align="center">
            <tr>
                <td>
                    <table border="0" cellspacing="10" cellpadding="3" align="center">
                        <tr>
                            <td><span class="style1">Quickjob Installation - Step: 1-3</span></td>
                            <td align="right" valign="bottom">&nbsp;</td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>Please select the language you would like Quickjob to use:<br><small style="color:#FF0000;">*Some parts of the installation may not be in your chosen language</small><Br><br>
        ...
        <table  border="0" align="center" cellpadding="10" cellspacing="3" align="center">
            <tr>
                <td>
                    <table border="0" cellspacing="10" cellpadding="3" align="center">
                        <tr>
                            <td><span class="style1">Quickjob Installation - Step: 2-4</span></td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <form name="form1" method="post" action="index.php" style="padding:0px;margin:0px;">
                        <table border="0" cellspacing="10" cellpadding="3" align="center">
                            <tr>
                                <td align="center">Enter Quickjob envato purchase code.</td>
                            <tr/>
                            <tr>
                                <td align="center">
                                    <?php
                        ...
                        <table border="0" cellspacing="0" cellpadding="3" align="center">
                            <tr>
                                ...
                                <td><span class="style12">&nbsp;<a href="javascript:alert('Quickjob Purchase code');">(?)</a> </span></td>
                            </tr>
        ...
        <table  border="0" align="center" cellpadding="10" cellspacing="3" align="center">
            <tr>
                <td>
                    <table border="0" cellspacing="10" cellpadding="3" align="center">
                        <tr>
                            <td><span class="style1">Quickjob Installation Step: 2-3</span></td>
                        </tr>
                    </table>
                </td>
            </tr>
                    ...
                    <form name="form1" method="post" action="index.php" style="padding:0px;margin:0px;">
                        ...
                        <table border="0" cellspacing="0" cellpadding="3" align="center">
                            ...
                            <tr>
                                ...
                                <td><input name="DBPre" type="text" id="DBPre" value="<?php if(isset($_POST['DBPre'])){ echo $_POST['DBPre']; } else { echo 'job_'; } ?>"></td>
        ...
        <table border="0" align="center" cellpadding="10" cellspacing="3" align="center">
            <tr>
                <td>
                    <table border="0" cellspacing="10" cellpadding="3" align="center">
                        <tr>
                            <td><span class="style1">Quickjob Installation Step: 3-3</span></td>
                            <td align="right" valign="bottom">&nbsp;</td>
                        </tr>
                    </table>
                </td>
        ...
        <table border="0" align="center" cellpadding="10" cellspacing="3" align="center">
            <tr>
                <td>
                    <table border="0" cellspacing="10" cellpadding="3" align="center">
                        <tr>
                            <td><span class="style1">Quickjob Installation</span></td>
                            <td align="right" valign="bottom">&nbsp;</td>
                        </tr>
                    </table>
                </td>
            ...
            <tr><td>Thank you for installing Quickjob, please use the links below:</td></tr>
